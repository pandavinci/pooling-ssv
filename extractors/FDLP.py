#! IMPORTANT: This is modified code from the original source.
#! Modifications are denoted by #! comments.
#! The reason for modifications is compatibility.
#! Source: https://github.com/sadhusamik/fdlp_spectrogram/blob/master/fdlp/fdlp.py
#! Their paper: https://arxiv.org/abs/2103.14129
import sys
...
class FDLP:
    def __init__(self,
        ...
        self.feature_size = n_filters #! added for compatibility
    ...
    #! removed ilens argument it is instead computed from input
    def extract_features(self, input):
        ...
        """
        #! input is a tensor, not a numpy array
        input = input.cpu().numpy()
        #! calculate ilens from input
        ilens = torch.tensor([input.shape[1]])
